...
var _0n, _1n, _2n, _3n, _4n, _5n, _8n, _9n, _16n, isNegativeLE, FIELD_FIELDS;
...
function twistedEdwards(curveDef) {
  ...
  const MASK = _2n2 << BigInt(nByteLength * 8) - _1n3;
...
var _0n3, _1n3, _2n2, _8n2, VERIFY_DEFAULT;
    ...
    RistPoint = class _RistPoint {
      ...
      static fromHex(hex) {
        ...
        if (!isValid || isNegativeLE(t, P) || y === _0n5)
          throw new Error(emsg);
        return new _RistPoint(new ed25519.ExtendedPoint(x, y, _1n5, t));
      }
      static msm(points, scalars) {
...
function weierstrassPoints(opts) {
  ...
  function isWithinCurveOrder(num2) {
    return inRange(num2, _1n6, CURVE.n);
  }
  function normPrivateKeyToScalar(key) {
    ...
    if (wrapPrivateKey)
      num2 = mod(num2, N);
    aInRange("private key", num2, _1n6, N);
    return num2;
  }
...
function weierstrass(curveDef) {
  ...
  function int2octets(num2) {
    aInRange("num < 2^" + CURVE.nBitLength, num2, _0n6, ORDER_MASK);
...
function SWUFpSqrtRatio(Fp2, Z) {
  ...
  const c7 = Fp2.pow(Z, (c2 + _1n6) / _2n4);
  let sqrtRatio = (u, v) => {
    let tv1 = c6;
...
function lift_x(x) {
  aInRange("x", x, _1n7, secp256k1P);
  const xx = modP(x * x);
  const c = modP(xx * x + BigInt(7));
  let y = sqrtMod(c);
  if (y % _2n5 !== _0n7)
    y = modP(-y);
  const p = new Point(x, y, _1n7);
  p.assertValidity();
  return p;
}
...
function schnorrVerify(signature2, message, publicKey2) {
  ...
  try {
    ...
    if (!inRange(r, _1n7, secp256k1P))
      return false;
    const s = num(sig.subarray(32, 64));
    if (!inRange(s, _1n7, secp256k1N))
      return false;
...
var secp256k1P, secp256k1N, _1n7, _2n5, divNearest, Fpk1, secp256k1, _0n7, TAGGED_HASH_PREFIXES, pointToBytes, numTo32b, modP, modN, Point, GmulAdd, num, schnorr, isoMap, mapSWU, secp256k1_hasher, hashToCurve2, encodeToCurve2;
var init_secp256k1 = __esm({
  "node_modules/@noble/curves/esm/secp256k1.js"() {
    ...
    secp256k1_hasher = (() => createHasher(secp256k1.ProjectivePoint, (scalars) => {
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-GNIAW6MB.js.map
