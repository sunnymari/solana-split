...
var require_dayjs_min = __commonJS({
  "node_modules/dayjs/dayjs.min.js"(exports, module) {
    !function(t2, e3) {
      ...
      "use strict";
      var t2 = 1e3, e3 = 6e4, n5 = 36e5, r3 = "millisecond", i5 = "second", s4 = "minute", u3 = "hour", a3 = "day", o5 = "week", c7 = "month", f8 = "quarter", h6 = "year", d5 = "date", l8 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y5 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M4 = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
        ...
        return { M: c7, y: h6, w: o5, d: a3, D: d5, h: u3, m: s4, s: i5, ms: r3, Q: f8 }[t3] || String(t3 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t3) {
        return void 0 === t3;
      } }, g4 = "en", D2 = {};
      D2[g4] = M4;
      ...
      var _4 = function() {
        ...
        return m5.parse = function(t3) {
          ...
          var n6 = this, r4 = !!b4.u(e4) || e4, f9 = b4.p(t3), l9 = function(t4, e5) {
          ...
          var n6, o6 = b4.p(t3), f9 = "set" + (this.$u ? "UTC" : ""), l9 = (n6 = {}, n6[a3] = f9 + "Date", n6[d5] = f9 + "Date", n6[c7] = f9 + "Month", n6[h6] = f9 + "FullYear", n6[u3] = f9 + "Hours", n6[s4] = f9 + "Minutes", n6[i5] = f9 + "Seconds", n6[r3] = f9 + "Milliseconds", n6)[o6], $2 = o6 === a3 ? this.$D + (e4 - this.$W) : e4;
          if (o6 === c7 || o6 === h6) {
          ...
          var r4 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i6 = b4.z(this), s5 = this.$H, u4 = this.$m, a4 = this.$M, o6 = n6.weekdays, c8 = n6.months, f9 = n6.meridiem, h7 = function(t4, n7, i7, s6) {
            return t4 && (t4[n7] || t4(e4, r4)) || i7[n7].slice(0, s6);
          }, d6 = function(t4) {
            return b4.s(s5 % 12 || 12, t4, "0");
          }, $2 = f9 || function(t4, e5, n7) {
            var r5 = t4 < 12 ? "AM" : "PM";
    ...
    !function(r3, e3) {
      ...
      return function(r3, e3, t2) {
        ...
        t2.en.relativeTime = o5, n5.fromToBase = function(e4, n6, i6, d6, u3) {
          for (var f8, a3, s4, l8 = i6.$locale().relativeTime || o5, h6 = r3.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m4 = h6.length, c7 = 0; c7 < m4; c7 += 1) {
            var y5 = h6[c7];
            y5.d && (f8 = d6 ? t2(e4).diff(i6, y5.d, true) : i6.diff(e4, y5.d, true));
            var p4 = (r3.rounding || Math.round)(Math.abs(f8));
            if (s4 = f8 > 0, p4 <= y5.r || !y5.r) {
...
function __generator(thisArg, body) {
  ...
  function step(op) {
    ...
    while (_4) try {
      if (f8 = 1, y5 && (t2 = op[0] & 2 ? y5["return"] : op[0] ? y5["throw"] || ((t2 = y5["return"]) && t2.call(y5), 0) : y5.next) && !(t2 = t2.call(y5, op[1])).done) return t2;
...
function __asyncGenerator(thisArg, _arguments, generator) {
  ...
  function settle(f8, v5) {
    if (f8(v5), q2.shift(), q2.length) resume(q2[0][0], q2[0][1]);
  }
}
function __asyncDelegator(o5) {
  ...
  function verb(n5, f8) {
    i5[n5] = o5[n5] ? function(v5) {
      return (p4 = !p4) ? { value: __await(o5[n5](v5)), done: n5 === "return" } : f8 ? f8(v5) : v5;
    } : f8;
  }
}
...
function __asyncDelegator2(o5) {
  ...
  function verb(n5, f8) {
    i5[n5] = o5[n5] ? function(v5) {
      return (p4 = !p4) ? { value: __await2(o5[n5](v5)), done: n5 === "return" } : f8 ? f8(v5) : v5;
    } : f8;
  }
}
...
var O = async (i5, t2, e3) => {
  ...
  for (; a3.length; ) {
    ...
    if (o5.includes("wc@") || o5.includes("walletconnect") || o5.includes("wc_") || o5.includes("wallet_connect")) {
      ...
      await t2.setItem(r3, f8), m4.push(r3);
    }
  }
...
function yr(t2) {
  const e3 = gr(t2), { Fp: n5, n: r3, prehash: o5, hash: s4, randomBytes: a3, nByteLength: u3, h: i5 } = e3, D2 = yt << BigInt(u3 * 8) - j2, c7 = n5.create, l8 = _e(e3.n, e3.nBitLength), p4 = e3.uvRatio || ((y5, f8) => {
    try {
      return { isValid: true, value: n5.sqrt(y5 * n5.inv(f8)) };
    } catch {
      return { isValid: false, value: G };
    }
  }), w4 = e3.adjustScalarBytes || ((y5) => y5), h6 = e3.domain || ((y5, f8, b4) => {
    if (Tt("phflag", b4), f8.length || b4) throw new Error("Contexts/pre-hash are not supported");
    return y5;
  });
  function g4(y5, f8) {
    ft("coordinate " + y5, f8, G, D2);
  }
  function S3(y5) {
  ...
  const v5 = xe((y5, f8) => {
    ...
    f8 == null && (f8 = C5 ? wr : n5.inv(B3));
    const A2 = c7(b4 * f8), U2 = c7(E4 * f8), _4 = c7(B3 * f8);
    ...
    const { ex: E4, ey: B3, ez: C5, et: A2 } = y5, U2 = c7(E4 * E4), _4 = c7(B3 * B3), T4 = c7(C5 * C5), $ = c7(T4 * T4), R2 = c7(U2 * f8), V3 = c7(T4 * c7(R2 + _4)), Y2 = c7($ + c7(b4 * c7(U2 * _4)));
  ...
  class d5 {
    constructor(f8, b4, E4, B3) {
      this.ex = f8, this.ey = b4, this.ez = E4, this.et = B3, g4("x", f8), g4("y", b4), g4("z", E4), g4("t", B3), Object.freeze(this);
    }
    get x() {
    ...
    static normalizeZ(f8) {
      ...
      return f8.map((E4, B3) => E4.toAffine(b4[B3])).map(d5.fromAffine);
    }
    static msm(f8, b4) {
      return br(d5, l8, f8, b4);
    }
    _setWindowSize(f8) {
    ...
    equals(f8) {
      S3(f8);
      const { ex: b4, ey: E4, ez: B3 } = this, { ex: C5, ey: A2, ez: U2 } = f8, _4 = c7(b4 * U2), T4 = c7(C5 * B3), $ = c7(E4 * U2), R2 = c7(A2 * B3);
      return _4 === T4 && $ === R2;
    }
    is0() {
    ...
    double() {
      const { a: f8 } = e3, { ex: b4, ey: E4, ez: B3 } = this, C5 = c7(b4 * b4), A2 = c7(E4 * E4), U2 = c7(yt * c7(B3 * B3)), _4 = c7(f8 * C5), T4 = b4 + E4, $ = c7(c7(T4 * T4) - C5 - A2), R2 = _4 + A2, V3 = R2 - U2, Y2 = _4 - A2, Z2 = c7($ * V3), X = c7(R2 * Y2), et3 = c7($ * Y2), pt2 = c7(V3 * R2);
      return new d5(Z2, X, pt2, et3);
    }
    add(f8) {
      S3(f8);
      const { a: b4, d: E4 } = e3, { ex: B3, ey: C5, ez: A2, et: U2 } = this, { ex: _4, ey: T4, ez: $, et: R2 } = f8;
      if (b4 === BigInt(-1)) {
    ...
    static fromHex(f8, b4 = false) {
      ...
      f8 = W("pointHex", f8, C5), Tt("zip215", b4);
      const A2 = f8.slice(), U2 = f8[C5 - 1];
      A2[C5 - 1] = U2 & -129;
    ...
    toRawBytes() {
      ...
      return E4[E4.length - 1] |= f8 & j2 ? 128 : 0, E4;
    }
    toHex() {
  ...
  function O6(y5) {
    ...
    const b4 = W("hashed private key", s4(y5), 2 * f8), E4 = w4(b4.slice(0, f8)), B3 = b4.slice(f8, 2 * f8), C5 = I3(E4), A2 = m4.multiply(C5), U2 = A2.toRawBytes();
    return { head: E4, prefix: B3, scalar: C5, point: A2, pointBytes: U2 };
  }
  function ot2(y5) {
    return O6(y5).pointBytes;
  }
  function tt2(y5 = new Uint8Array(), ...f8) {
    const b4 = ye(...f8);
    return I3(s4(h6(b4, W("context", y5), !!o5)));
  }
  function st2(y5, f8, b4 = {}) {
    y5 = W("message", y5), o5 && (y5 = o5(y5));
    const { prefix: E4, scalar: B3, pointBytes: C5 } = O6(f8), A2 = tt2(b4.context, E4, y5), U2 = m4.multiply(A2).toRawBytes(), _4 = tt2(b4.context, U2, C5, y5), T4 = z4(A2 + _4 * B3);
    ft("signature.s", T4, G, r3);
    const $ = ye(U2, Nt(T4, n5.BYTES));
    return W("result", $, n5.BYTES * 2);
  }
  const at = Er;
  function Ct3(y5, f8, b4, E4 = at) {
    const { context: B3, zip215: C5 } = E4, A2 = n5.BYTES;
    y5 = W("signature", y5, 2 * A2), f8 = W("message", f8), b4 = W("publicKey", b4, A2), C5 !== void 0 && Tt("zip215", C5), o5 && (f8 = o5(f8));
    ...
    const R2 = tt2(B3, T4.toRawBytes(), _4.toRawBytes(), f8);
    return T4.add(_4.multiplyUnsafe(R2)).subtract($).clearCofactor().equals(d5.ZERO);
  }
  return m4._setWindowSize(8), { CURVE: e3, getPublicKey: ot2, sign: st2, verify: Ct3, ExtendedPoint: d5, utils: { getExtendedPublicKey: O6, randomPrivateKey: () => a3(n5.BYTES), precompute(y5 = 8, f8 = d5.BASE) {
...
function Mo2(e3, t2 = 24) {
  ...
  for (let r3 = 24 - t2; r3 < 24; r3++) {
    ...
    for (let i5 = 0; i5 < 10; i5 += 2) {
      const c7 = (i5 + 8) % 10, u3 = (i5 + 2) % 10, a3 = n5[u3], l8 = n5[u3 + 1], f8 = pn(a3, l8, 1) ^ n5[c7], d5 = gn2(a3, l8, 1) ^ n5[c7 + 1];
      for (let g4 = 0; g4 < 50; g4 += 10) e3[i5 + g4] ^= f8, e3[i5 + g4 + 1] ^= d5;
    }
    let o5 = e3[2], s4 = e3[3];
...
function Es(e3, t2, n5, r3, o5, s4, i5, c7) {
  const u3 = o5.length, a3 = new Uint8Array(Ve2), l8 = se(a3), f8 = yt2(o5) && yt2(s4), d5 = f8 ? se(o5) : Vn2, g4 = f8 ? se(s4) : Vn2;
...
function vs(e3, t2) {
  ...
  return ht2(o5), ht2(i5), jn2(s4), jn2(n5), (c7, u3, a3, l8, f8 = 0) => {
    F(c7), F(u3), F(a3);
    const d5 = a3.length;
    if (l8 === void 0 && (l8 = new Uint8Array(d5)), F(l8), ht2(f8), f8 < 0 || f8 >= Mn2) throw new Error("arx: counter overflow");
    ...
    const _4 = se(u3);
    return Es(e3, m4, L3, _4, a3, l8, f8, i5), Ee2(...g4), l8;
  };
}
...
var xs = class {
  ...
  process(t2, n5, r3 = false) {
    const o5 = r3 ? 0 : 2048, { h: s4, r: i5 } = this, c7 = i5[0], u3 = i5[1], a3 = i5[2], l8 = i5[3], f8 = i5[4], d5 = i5[5], g4 = i5[6], y5 = i5[7], h6 = i5[8], m4 = i5[9], L3 = M3(t2, n5 + 0), b4 = M3(t2, n5 + 2), _4 = M3(t2, n5 + 4), O6 = M3(t2, n5 + 6), k5 = M3(t2, n5 + 8), E4 = M3(t2, n5 + 10), B3 = M3(t2, n5 + 12), j4 = M3(t2, n5 + 14);
    ...
    p4 = C5 >>> 13, C5 &= 8191, C5 += T4 * (5 * d5) + N10 * (5 * f8) + S3 * (5 * l8) + U2 * (5 * a3) + $ * (5 * u3), p4 += C5 >>> 13, C5 &= 8191;
    let D2 = p4 + v5 * u3 + I3 * c7 + w4 * (5 * m4) + R2 * (5 * h6) + A2 * (5 * y5);
    p4 = D2 >>> 13, D2 &= 8191, D2 += T4 * (5 * g4) + N10 * (5 * d5) + S3 * (5 * f8) + U2 * (5 * l8) + $ * (5 * a3), p4 += D2 >>> 13, D2 &= 8191;
    let P6 = p4 + v5 * a3 + I3 * u3 + w4 * c7 + R2 * (5 * m4) + A2 * (5 * h6);
    p4 = P6 >>> 13, P6 &= 8191, P6 += T4 * (5 * y5) + N10 * (5 * g4) + S3 * (5 * d5) + U2 * (5 * f8) + $ * (5 * l8), p4 += P6 >>> 13, P6 &= 8191;
    let G3 = p4 + v5 * l8 + I3 * a3 + w4 * u3 + R2 * c7 + A2 * (5 * m4);
    p4 = G3 >>> 13, G3 &= 8191, G3 += T4 * (5 * h6) + N10 * (5 * y5) + S3 * (5 * g4) + U2 * (5 * d5) + $ * (5 * f8), p4 += G3 >>> 13, G3 &= 8191;
    let X = p4 + v5 * f8 + I3 * l8 + w4 * a3 + R2 * u3 + A2 * c7;
    p4 = X >>> 13, X &= 8191, X += T4 * (5 * m4) + N10 * (5 * h6) + S3 * (5 * y5) + U2 * (5 * g4) + $ * (5 * d5), p4 += X >>> 13, X &= 8191;
    let Z2 = p4 + v5 * d5 + I3 * f8 + w4 * l8 + R2 * a3 + A2 * u3;
    p4 = Z2 >>> 13, Z2 &= 8191, Z2 += T4 * c7 + N10 * (5 * m4) + S3 * (5 * h6) + U2 * (5 * y5) + $ * (5 * g4), p4 += Z2 >>> 13, Z2 &= 8191;
    let he3 = p4 + v5 * g4 + I3 * d5 + w4 * f8 + R2 * l8 + A2 * a3;
    p4 = he3 >>> 13, he3 &= 8191, he3 += T4 * u3 + N10 * c7 + S3 * (5 * m4) + U2 * (5 * h6) + $ * (5 * y5), p4 += he3 >>> 13, he3 &= 8191;
    let pe2 = p4 + v5 * y5 + I3 * g4 + w4 * d5 + R2 * f8 + A2 * l8;
    p4 = pe2 >>> 13, pe2 &= 8191, pe2 += T4 * a3 + N10 * u3 + S3 * c7 + U2 * (5 * m4) + $ * (5 * h6), p4 += pe2 >>> 13, pe2 &= 8191;
    let ge2 = p4 + v5 * h6 + I3 * y5 + w4 * g4 + R2 * d5 + A2 * f8;
    p4 = ge2 >>> 13, ge2 &= 8191, ge2 += T4 * l8 + N10 * a3 + S3 * u3 + U2 * c7 + $ * (5 * m4), p4 += ge2 >>> 13, ge2 &= 8191;
    let ye2 = p4 + v5 * m4 + I3 * h6 + w4 * y5 + R2 * g4 + A2 * d5;
    p4 = ye2 >>> 13, ye2 &= 8191, ye2 += T4 * f8 + N10 * l8 + S3 * a3 + U2 * u3 + $ * c7, p4 += ye2 >>> 13, ye2 &= 8191, p4 = (p4 << 2) + p4 | 0, p4 = p4 + C5 | 0, C5 = p4 & 8191, p4 = p4 >>> 13, D2 += p4, s4[0] = C5, s4[1] = D2, s4[2] = P6, s4[3] = G3, s4[4] = X, s4[5] = Z2, s4[6] = he3, s4[7] = pe2, s4[8] = ge2, s4[9] = ye2;
  }
  finalize() {
...
function As(e3, t2, n5, r3, o5, s4 = 20) {
  let i5 = e3[0], c7 = e3[1], u3 = e3[2], a3 = e3[3], l8 = t2[0], f8 = t2[1], d5 = t2[2], g4 = t2[3], y5 = t2[4], h6 = t2[5], m4 = t2[6], L3 = t2[7], b4 = o5, _4 = n5[0], O6 = n5[1], k5 = n5[2], E4 = i5, B3 = c7, j4 = u3, v5 = a3, I3 = l8, w4 = f8, R2 = d5, A2 = g4, T4 = y5, N10 = h6, S3 = m4, U2 = L3, $ = b4, p4 = _4, C5 = O6, D2 = k5;
  ...
  let P6 = 0;
  r3[P6++] = i5 + E4 | 0, r3[P6++] = c7 + B3 | 0, r3[P6++] = u3 + j4 | 0, r3[P6++] = a3 + v5 | 0, r3[P6++] = l8 + I3 | 0, r3[P6++] = f8 + w4 | 0, r3[P6++] = d5 + R2 | 0, r3[P6++] = g4 + A2 | 0, r3[P6++] = y5 + T4 | 0, r3[P6++] = h6 + N10 | 0, r3[P6++] = m4 + S3 | 0, r3[P6++] = L3 + U2 | 0, r3[P6++] = b4 + $ | 0, r3[P6++] = _4 + p4 | 0, r3[P6++] = O6 + C5 | 0, r3[P6++] = k5 + D2 | 0;
}
...
var js = class extends it2 {
  ...
  digestInto(t2) {
    ...
    for (let f8 = i5; f8 < o5; f8++) n5[f8] = 0;
    ...
    for (let f8 = 0; f8 < a3; f8++) c7.setUint32(4 * f8, l8[f8], s4);
  }
  digest() {
    const { buffer: t2, outputLen: n5 } = this;
    this.digestInto(t2);
...
var ks = class extends js {
  ...
  process(t2, n5) {
    for (let f8 = 0; f8 < 16; f8++, n5 += 4) ce[f8] = t2.getUint32(n5, false);
    for (let f8 = 16; f8 < 64; f8++) {
      const d5 = ce[f8 - 15], g4 = ce[f8 - 2], y5 = J3(d5, 7) ^ J3(d5, 18) ^ d5 >>> 3, h6 = J3(g4, 17) ^ J3(g4, 19) ^ g4 >>> 10;
      ce[f8] = h6 + ce[f8 - 7] + y5 + ce[f8 - 16] | 0;
    }
    let { A: r3, B: o5, C: s4, D: i5, E: c7, F: u3, G: a3, H: l8 } = this;
    for (let f8 = 0; f8 < 64; f8++) {
      const d5 = J3(c7, 6) ^ J3(c7, 11) ^ J3(c7, 25), g4 = l8 + d5 + Bs(c7, u3, a3) + Cs[f8] + ce[f8] | 0, h6 = (J3(r3, 2) ^ J3(r3, 13) ^ J3(r3, 22)) + Ls(r3, o5, s4) | 0;
...
function Js(e3) {
  ...
  function h6(b4, _4) {
    const O6 = g4(_4), k5 = y5(b4), E4 = f8(O6, k5);
...
BigInt(8);
function Qs(e3) {
  const t2 = BigInt(10), n5 = BigInt(20), r3 = BigInt(40), o5 = BigInt(80), s4 = xt2, c7 = e3 * e3 % s4 * e3 % s4, u3 = z3(c7, tr2, s4) * c7 % s4, a3 = z3(u3, Ys, s4) * e3 % s4, l8 = z3(a3, Zs, s4) * a3 % s4, f8 = z3(l8, t2, s4) * l8 % s4, d5 = z3(f8, n5, s4) * f8 % s4, g4 = z3(d5, r3, s4) * d5 % s4, y5 = z3(g4, o5, s4) * g4 % s4, h6 = z3(y5, o5, s4) * g4 % s4, m4 = z3(h6, t2, s4) * l8 % s4;
...
var idxR2 = [Pi3];
for (let i5 = 0; i5 < 4; i5++)
  for (let j4 of [idxL2, idxR2])
    j4.push(j4[i5].map((k5) => Rho2[k5]));
var shifts2 = [
  [11, 14, 15, 12, 5, 8, 7, 9, 11, 13, 14, 15, 6, 7, 9, 8],
  [12, 13, 11, 15, 6, 9, 9, 7, 12, 15, 11, 13, 7, 8, 7, 7],
  [13, 15, 14, 11, 7, 7, 6, 8, 13, 14, 13, 12, 5, 5, 6, 9],
...
var shiftsL2 = idxL2.map((idx, i5) => idx.map((j4) => shifts2[i5][j4]));
var shiftsR2 = idxR2.map((idx, i5) => idx.map((j4) => shifts2[i5][j4]));
...
var RIPEMD1602 = class extends HashMD3 {
  ...
  process(view, offset) {
    ...
    for (let group = 0; group < 5; group++) {
      ...
      for (let i5 = 0; i5 < 16; i5++) {
        const tr4 = rotl3(ar3 + f7(rGroup, br3, cr3, dr3) + R_BUF2[rr4[i5]] + hbr, sr3[i5]) + er4 | 0;
...
var shiftsL160 = idxL3.map((idx, i5) => idx.map((j4) => shifts160[i5][j4]));
var shiftsR160 = idxR3.map((idx, i5) => idx.map((j4) => shifts160[i5][j4]));
...
var RIPEMD1603 = class extends HashMD {
  constructor() {
    super(64, 20, 8, true);
    this.h0 = 1732584193 | 0;
    this.h1 = 4023233417 | 0;
...
var ripemd1605 = createHasher(() => new RIPEMD1603());
...
@walletconnect/utils/dist/index.es.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-NJ32GYW4.js.map
